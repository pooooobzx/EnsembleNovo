...
class DeNovoDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self) -> torch.utils.data.DataLoader:
        ...
        M= 4200000 #498183   #Sample the training set if needed since some dataset is too large to finish entire epoch
        #sampler = RandomSampler(self.train_dataset, replacement=True, num_samples=M)
        sampler = None
        
        #sampler = MyRandomSampler_adapt(self.train_dataset, N_1 = 100000, N_2 = 1)
